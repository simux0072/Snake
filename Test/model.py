...
class Linear_QNet(nn.Module):
    def __init__(self, input_size, hidden_size, output_size):
        super().__init__()
        self.linear1 = nn.Linear(input_size, round(hidden_size/2))
        self.linear2 = nn.Linear(round(hidden_size/2), hidden_size)
        self.linear3 = nn.Linear(hidden_size, round(hidden_size/2))
        self.out = nn.Linear(round(hidden_size/2), output_size)
